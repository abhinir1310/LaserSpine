...
@section('content')
    ...
    <div class="breadcrumb-outer">
    	<div class="auto-container">
        	<ul class="bread-crumb text-center">
            	<li><a href="{{route('front')}}">Home</a> <span class="fa fa-angle-right"></span></li>
                <li>About Us</li>
            </ul>
        </div>
    </div>
			...
			<div class="row clearfix">
				...
				<div class="video-column col-lg-6 col-md-12 col-sm-12">
					<div class="inner-column">
                        ...
                        <div class="video-box">
                            <figure class="image">
                                <img src="{{asset('front/img/172044344.jpg')}}" alt="">
                            </figure>
                        </div>
    ...
    <section class="fluid-section-one">
    	<div class="outer-container clearfix">
            ...
            <!--Image Column-->
            <div class="image-column" style="background-image:url({{asset('front/img/kjb234l.PNG')}});">
            	<figure class="image-box"><img src="{{asset('front/img/kjb234l.PNG')}}" alt=""></figure>
            </div>
