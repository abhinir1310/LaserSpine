...
<head>
<meta charset="utf-8">
<title>Laser Clinic - Spine services </title>
<!-- Stylesheets -->
...
<div class="page-wrapper">
    	...
    	<div class="header-top">
    		<div class="auto-container">
				<div class="clearfix">
					<!--Top Left-->
					<div class="top-left">
						<div class="text">Welcome to Laser Spine - Centre for Minimally Invasive Spine Surgery</div>
					</div>
					<!--Top Right-->
					<div class="top-right">
						<!--Social Box-->
						<ul class="social-box">
							<li><a href="https://www.facebook.com/www.laserspine.in/"><span class="fa fa-facebook"></span></a></li>
        	...
        	<div class="auto-container">
            	<div class="clearfix">
                	...
                	<div class="pull-left logo-box">
                    	<div class="logo"><a href="<?php echo e(route('front')); ?>"><img src="<?php echo e(asset('front/img/logo.png')); ?>" alt="" title="" width="210px;"></a></div>
                    </div>
                    ...
                    <div class="pull-right upper-right clearfix">
                        ...
                        <div class="upper-column info-box">
                            ...
                            <ul>
								<li>13005 Greenville Avenue <br> Mumbai/Patna, TX 70240</li>
                            </ul>
                        </div>
                        ...
                        <div class="upper-column info-box">
                            ...
                            <ul>
								<li>+91 919004549623 <br> drlaserspine@gmail.com</li>
                            </ul>
                        </div>
                        ...
                        <div class="upper-column info-box">
                            ...
                            <ul>
								<li>10:00 am – 08:00 pm <br> Sunday Closed</li>
                            </ul>
                        </div>
                    ...
                    <nav class="main-menu navbar-expand-md">
                        ...
                        <div class="navbar-collapse collapse clearfix" id="navbarSupportedContent">
                            <ul class="navigation clearfix">
								...
								<li class=""><a href="spine-services">SPINE SERVICES</a>
									
								</li>
								<li class=""><a href="spine-surgeries">SPINE SURGERIES
</a>
									
								</li>
								<li class=""><a href="publications-reserch">PUBLICATIONS & RESERCH</a>
									
								</li>
								<li class=""><a href="awards-recognitions">AWARDS & RECOGNITIONS</a>
									...
									<div class="dropdown-menu pull-right cart-panel" aria-labelledby="dropdownMenu3">
										...
										<div class="cart-product">
											<div class="inner">
												...
												<div class="image"><img src="<?php echo e(asset('front/images/resource/post-thumb-3.jpg')); ?>" alt="" /></div>
										...
										<div class="cart-product">
											<div class="inner">
												<div class="cross-icon"><span class="icon fa fa-remove"></span></div>
												<div class="image"><img src="<?php echo e(asset('front/images/resource/post-thumb-2.jpg')); ?>" alt="" /></div>
        ...
        <div class="sticky-header">
        	<div class="auto-container clearfix">
            	...
            	<div class="logo pull-left">
                	<a href="<?php echo e(route('front')); ?>" class="img-responsive"><img src="<?php echo e(asset('front/img/logo.png')); ?>" alt="" title="" width="200px;"></a>
                </div>
			...
			<div class="row clearfix">
				...
				<div class="content-column col-lg-6 col-md-12 col-sm-12">
					<div class="inner-column">
						<div class="sec-title">
							<h2>Laser Spine -Where Less is more.</h2>
						</div>
				...
				<div class="video-column col-lg-6 col-md-12 col-sm-12">
					<div class="inner-column">
                        ...
                        <div class="video-box">
                            ...
                            <video width="640" height="360" controls frameborder="0" allowfullscreen>
  <source src="<?php echo e(asset('front/vfile.mp4')); ?>" type="video/mp4">
  Your browser does not support the video tag.
	...
	<section class="case-section alternate gallery-page-case">
		<div class="auto-container">
			...
			<div class="sec-title centered">
				<h2>PHOTO GALLERY-WE OFFER COMPLETE RANGE OF SPINE SURGERIES</h2>
			</div>
		</div>
		<!--Four Item Carousel-->
		<div class="four-item-carousel owl-carousel owl-theme">
			...
			<div class="case-block">
				<div class="inner-box">
					<div class="image">
						<img src="<?php echo e(asset('front/img/g1.webp')); ?>" alt="" />
			...
			<div class="case-block">
				<div class="inner-box">
					<div class="image">
						<img src="<?php echo e(asset('front/img/g9.webp')); ?>" alt="" />
						<div class="overlay-box">
							<div class="overlay-inner">
								<div class="content">
			...
			<div class="case-block">
				<div class="inner-box">
					<div class="image">
						<img src="<?php echo e(asset('front/img/g3.webp')); ?>" alt="" />
						<div class="overlay-box">
							<div class="overlay-inner">
								<div class="content">
			...
			<div class="case-block">
				<div class="inner-box">
					<div class="image">
						<img src="<?php echo e(asset('front/img/g7.webp')); ?>" alt="" />
						<div class="overlay-box">
							<div class="overlay-inner">
								<div class="content">
			...
			<div class="case-block">
				<div class="inner-box">
					<div class="image">
						<img src="<?php echo e(asset('front/img/g5.webp')); ?>" alt="" />
						<div class="overlay-box">
							<div class="overlay-inner">
								<div class="content">
	...
	<section class="faq-section">
		<div class="auto-container">
			<div class="sec-title">
				<h2>Services- Non- operative treatment for back pain/Neck pain</h2>
			</div>
			<!--Accordion Box-->
			<ul class="accordion-box">
				...
				<li class="accordion block">
					<div class="acc-btn active"><div class="icon-outer"><span class="icon icon-plus fa fa-arrow-right"></span> <span class="icon icon-minus fa fa-arrow-down"></span></div> <span class="icon-inner flaticon-pie-chart-3"></span>24 Hour Service</div>
					<div class="acc-content current">
						<div class="content">
							<p>We know that your medical needs don't stop when office hours are over. Using our help line and email service, you can get a message across to your health team and get prompt answers.</p>
						</div>
					</div>
				</li>
				...
				<!--Block-->
				<li class="accordion block">
					<div class="acc-btn"><div class="icon-outer"><span class="icon icon-plus fa fa-arrow-right"></span> <span class="icon icon-minus fa fa-arrow-down"></span></div> <span class="icon-inner flaticon-up-arrow-1"></span>Wellness Support</div>
					<div class="acc-content">
						<div class="content">
							<p>Our team will support you in building a healthier you. No matter what your health needs are, having a team support you will keep you on the path to meeting them. We work together to connect you with the services you need.</p>
						</div>
					</div>
				</li>

				<li class="accordion block">
					<div class="acc-btn"><div class="icon-outer"><span class="icon icon-plus fa fa-arrow-right"></span> <span class="icon icon-minus fa fa-arrow-down"></span></div> <span class="icon-inner flaticon-pyramid-scheme"></span>A Healthy Community</div>
					<div class="acc-content">
						<div class="content">
							<p>When you choose us, you join a community. We work not just with you but with other members of our community to build a network of allied health professionals working together for a healthier world.</p>
						</div>
					</div>
				</li>
					...
					<div class="row clearfix">
						...
						<div class="info-block col-md-4 col-sm-6 col-xs-12">
							<div class="inner">
								...
								<h6>Email at</h6>
								<div class="text">drlaserspine@gmail.com</div>
							</div>
						</div>
				...
				<div class="auto-container">
					<div class="row clearfix">
						<div class="column col-md-12 col-sm-12 col-xs-12">
							<div class="copyright"><a target="_blank" href="javascript:void(0);">COPYRIGHT © 2021 LASER SPINE - CENTRE FOR MINIMALLY INVASIVE SPINE SURGERY - ALL RIGHTS RESERVED.</a></div>
						</div>
...
<!--  30:20-->
</html><?php /**PATH /home/u218248846/domains/onestopneeds.com/public_html/sanjivani/resources/views/front/spine_services.blade.php ENDPATH**/ ?>