...
<html lang="en">
   <head>
      ...
      <title>Laser Clinic - <?php echo $__env->yieldContent('title'); ?> </title>
         ...
         <div id="wrapper">
            ...
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
               ...
               <li class="nav-item">
                  ...
                  <i class="fas fa-fw fa-users"></i>
                  <span><?php echo e(__('Doctors')); ?></span>
                  </a>
                  <div id="doctor" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                     <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="<?php echo e(route('doctor.create')); ?>"><?php echo e(__('New Doctor')); ?></a>
                        <a class="collapse-item" href="<?php echo e(route('doctor.all')); ?>"><?php echo e(__('All Doctors')); ?></a>
                     </div>
                  </div>
               </li>
               ...
               <li class="nav-item">
                  ...
                  <div id="inquiry" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                     <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="<?php echo e(route('inquiry.all')); ?>">All Inquiry</a>
                     </div>
                  </div>
               </li>
               ...
               <li class="nav-item">
                  ...
                  <div id="collapseSettings" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                     <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="<?php echo e(route('doctorino_settings.edit')); ?>">Settings</a>
                        <a class="collapse-item" href="<?php echo e(route('prescription_settings.edit')); ?>">Prescription Settings</a>
                     </div>
                  </div>
               </li>
               <!-- Divider -->
                  ...
                  <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                     ...
                     <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                           ...
                           <img class="img-profile rounded-circle" src="<?php echo e(asset('backend/img/undraw_profile.svg')); ?>">
                           </a>
...
</html><?php /**PATH /home/u218248846/domains/laserclinicpatna.com/public_html/resources/views/layouts/master.blade.php ENDPATH**/ ?>