                              ...
                              <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                          <select class="form-control" name="type[]">
                                            <option value="Type"><?php echo e(__('sentence.Type')); ?></option>
                              ...
                              <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                          <select class="form-control" name="dose[]">
                                            <option value="Dose"><?php echo e(__('sentence.Dose')); ?></option>
                                 ...
                                 <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                          <select class="form-control" name="duration[]">
                                            <option value="Duration"><?php echo e(__('sentence.Duration')); ?></option>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Hp\laravel8\laserspine\resources\views/prescription/create.blade.php ENDPATH**/ ?>