         ...
         <div class="card-body">
            ...
            <div class="row">
               ...
               <div class="col-md-3">
                  ...
                  <b style="font-size: 15px;"><?php echo e($doctor->speciality); ?></b><br>
               </div>
                
                <div class="col">
               <div class="col-md-3" style="float:right">
                   <b>Patient Id :</b> <?php echo e($prescription->id); ?><br>
                   <b><?php echo e(__('sentence.Patient Name')); ?> :</b> <?php echo e($prescription->User->name); ?>

                      <?php if(isset($prescription->User->Patient->birthday)): ?>
                      <b><?php echo e(__('sentence.Age')); ?> :</b> <?php echo e($prescription->User->Patient->birthday); ?>

                   <?php /*   ({{ \Carbon\Carbon::parse($prescription->User->Patient->birthday)->age }} Years) */ ?>
                    <?php endif; ?>
                    
                    
                  <p> <b>Date : </b> <?php echo e($prescription->created_at->format('d-m-Y')); ?></p>
               </div>
               </div>
            </div>
            <br><br>
            ...
            <br>
            <?php if(count($prescription_tests)): ?>
            <h3><?php echo e(__('Test')); ?> </h3>
            <!-- ROW : Drugs List -->
            <div class="row justify-content-center">
               <div class="col">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u218248846/domains/laserclinicpatna.com/public_html/resources/views/prescription/view.blade.php ENDPATH**/ ?>